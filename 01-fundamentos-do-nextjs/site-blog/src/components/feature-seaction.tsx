...
export function FeatureSection() {
    ...
    return (
        <section className="container py-12 md:py-30">
            <div className="grid grid-cols-1 gap-3  md:grid-cols-2 md:gap-6">
                ...
                <div className="bg-gray-500 p-6 md:p-12 rounded-xl flex flex-col gap-3 md:gap-4">
                    ...
                    <h2 className="text-gray-100 text-heading-sm md:text-heading-lg text-balance">Crie um catálogo de produtos online em poucos minutos</h2>
                </div>

                <div className="bg-gray-500 p-6 md:p-12 rounded-xl flex flex-col gap-3 md:gap-4">
                    <Badge className="w-fit">Prático</Badge>
                    <h2 className="text-gray-100 text-heading-sm md:text-heading-lg text-balance">Venda para seu público através de uma plataforma única</h2>
                </div>
                ...
                <div className="bg-gray-500 p-6 md:p-12 rounded-xl md:col-span-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-22">
                    <div className="flex flex-col gap-3 md:gap-4">
                        ...
                        <h2 className="text-gray-100 text-heading-sm md:text-heading-lg text-balance">Tenha uma loja online personalizada com a cara da sua marca</h2>
